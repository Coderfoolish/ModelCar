...
function createUser(e) {
  ...
  var fullnameRegex =
    /^[a-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỰỲỴÝỶỸửựỳỵýỷỹ ]+$/;
  ...
  if (!fullnameRegex.test(fullname.value)) {
    document.getElementById("fullnameerror").innerHTML = customAlert(
      "Sai định dạng tên",
      "warning"
    );
    flag = false;
  ...
  if (!address.value) {
    document.getElementById("addresserror").innerHTML = customAlert(
      "Sai định địa chỉ",
      "warning"
    );
    flag = false;
  ...
  if (!passwordPattern.test(password.value)) {
    document.getElementById("passworderror").innerHTML = customAlert(
      "Mật khẩu phải từ 8 kí tự trở lên, có ít nhất một chữ hoa, kí tự đặc biệt, chữ số",
      "warning"
    );
    flag = false;
  }
  if (password2.value !== password.value) {
    document.getElementById("password2error").innerHTML = customAlert(
...
function login(e) {
  ...
  document.getElementById("passwordloginerror").innerHTML = customAlert(
...
function onoffadvancedsearch() {
  ...
  if (flag.className == "off") {
    ...
    if (loca == "index") {
      document.querySelector("#btn-advancedsearch img").src =
        "images/icon/arrow2.svg";
    } else {
      document.querySelector("#btn-advancedsearch img").src =
        "../images/icon/arrow2.svg";
    }
...
function searching() {
  ...
  if (document.getElementById("advancedsearch").className == "on") {
    for (var i = 0; i < productArray.length; i++) {
      if (
        (productArray[i].productName.toLowerCase().search(text) > -1 ||
        ...
        Number(productArray[i].price) >= Number(priceform) &&
        Number(productArray[i].price) <= Number(priceto)
      ) {
...
function showSearchResult(selectPage) {
  ...
  var reSultPage = "<ul>";
  for (
    var i = numProduct * selectPage;
    i < numProduct * (selectPage + 1) && i < searchArray.length;
    i++
  ) {
    if (loca == "index") {
  ...
  if (numPage != 1) {
    for (var i = 0; i < numPage; i++) {
      if (i == selectPage) {
        reSultPage +=
          '<li><button onclick="showSearchResult(' +
          i +
          ')" style="background-color: #C70039;color: #fff">' +
          (i + 1) +
          "</button></li>";
      } else {
        reSultPage +=
    ...
    for (var i = 0; i < cartArray.length; i++) {
      if (cartArray[i].productID == producttmp.productID) {
        cartArray[i].quantity =
          Number(cartArray[i].quantity) + Number(quantity.value);
        flag = true;
        break;
      }
    }
...
function showCartTable() {
  if (
    ...
    for (var i = 0; i < cartArray.length; i++) {
      ...
      totalprice += Number(
        currency(cartArray[i].price * cartArray[i].quantity)
      );
    }
    ...
    var productArray = [
      {
        productID: "P0001",
        productName:
          "Bburago F1 Ferrari F1-75 #16 (Charles Leclerc) 2022 Formula 1 Model Car 1/43",
      ...
      },
      {
        productID: "P0003",
        productName:
          "Bburago Scuderia F1 Ferrari 2022 - SF21 #16 (Charles Leclerc) 2022 Model Car 1/43",
      ...
      },
      {
        productID: "P0006",
        productName:
          "Maisto Premium RC F1 Ferrari SF90 2019 Season Leclerc 1/24",
      ...
      },
      {
        productID: "P0007",
        productName:
          "Bburago Ferrari Racing 488 Challenge (Formula Ferrari Racing 2017) 1/24 Model Car",
      ...
      // TOYOTAAAAAAAA
      {
        productID: "P0013",
        productName:
          "Solido 1993 Toyota Supra Mk.4 (A80) - Renaissance Red Car Model 1/18",
      ...
      },
      {
        productID: "P0015",
        productName:
          "Solido 2023 Toyota GR Supra Streetfighter - Prominance Red Car Model 1/8",
      ...
      },
      {
        productID: "P0017",
        productName:
          "Ixo Toyota Yaris Pandem White 1/43 Diecast Scale Model Car",
      ...
      },
      {
        productID: "P0021",
        productName:
          "AutoArt Toyota Celica Liftback 2000GT (RA25) 1973 (Turquoise Blue Metallic) 1/18",
      ...
      },
      {
        productID: "P0024",
        productName:
          "IXO Toyota Yaris WRC #69 Rally Ypres 2021 K.Rovanpera/J.Halttunen 1/43",
      ...
      },
      {
        productID: "P0031",
        productName:
          "Maisto Lamborghini Aventador Lp 700-4 Roadster Model Car Kit 1/24",
      ...
      },
      {
        productID: "P0035",
        productName:
          "Maisto Lamborghini Aventador LP700-4 Assorted Colours Model Car 1/24",
      ...
      // MC Laren----------------------------------------------------------------
      {
        productID: "P0037",
        productName:
          "AutoArt 2017 McLaren 720S (paris blue/metallic blue) 1/18",
      ...
      },
      {
        productID: "P0038",
        productName:
          "AutoArt 2018 McLaren Senna (trophy kyanos/blue) (composite model) 1/18",
      ...
      },
      {
        productID: "P0042",
        productName:
          "Solido McLaren F1 GTR Short Tail #39 - 1996 24H Le Mans Car Model 1/18",
      ...
      },
      {
        productID: "P0043",
        productName:
          "AutoArt 2018 McLaren Senna (vision victory/grey)(composite model) 1/18",
      ...
      },
      {
        productID: "P0044",
        productName:
          "AutoArt McLaren P1 GTR (Dark Grey Metallic/Orange Accents) 1/18",
      ...
      },
      {
        productID: "P0045",
        productName:
          "Minichamps McLaren F1 Team MCL35M - Lando Norris Bahrain GP 2022 1/43",
      ...
      },
      {
        productID: "P0047",
        productName:
          "Spark Models Mercedes McLaren - F1 MCL35L M12 EQ Power+ P3 Abu Dhabi GP 2021 Daniel Ricciardo 1/43",
      ...
      },
      {
        productID: "P0062",
        productName:
          "AutoArt 2019 McLaren 600LT (myan orange) Model Car (composite) 1/18",
      ...
      },
      {
        productID: "P0063",
        productName:
          "AutoArt Mclaren P1 (fire black w/red/black interior) 1/18",
      ...
      },
      {
        productID: "P0058",
        productName:
          "Maisto Premium Remote Controlled Porsche Taycan 2.4ghz 1/24",
      ...
      },
      {
        productID: "P0060",
        productName:
          "IXO Porsche 919 Hybrid #1 24h Le Mans 2017 Jani/Tandy/Lotterer 1/18",
...
function shuffle(productArray) {
  var currentIndex = productArray.length,
    temporaryValue,
    randomIndex;
...
var specialButton = document.querySelectorAll(
...
function showBrandProducts(brand, index) {
  ...
  document.querySelector(".specialProducts-list").innerHTML =
    str +
    ` <div id="page">
          </div>`;
...
function brandPagination(brand) {
  brand = brand.toLowerCase();
  var quantityOfPages = Math.ceil(
    JSON.parse(localStorage.getItem(brand)).length / brandProductPerPage
  );
  var button = "";
...
function pagination(type) {
  var quantityOfPages = Math.ceil(
    JSON.parse(localStorage.getItem(type + "Product")).length /
      specialProductsPerPage
  );
  if (quantityOfPages != 1) {
    var button = "";
    for (var i = 1; i <= quantityOfPages; i++) {
